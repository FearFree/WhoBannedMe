...
public class UpdateCheck {
	...
	if (plugin.updateCheck == true) {
		...
		if (cV1.length == 3) {
		    ...
		    plugin.getLogger().log(Level.INFO, "currentVersion = {0}", currentVersion);
		}
	    }
	    //int currentVersion = Integer.parseInt(cV2);
		...
		plugin.getLogger().info("An update is available! Get it at http://dev.bukkit.org/bukkit-plugins/whobannedme");
	    }
	}
    }
}
